...
async function main() {
    ...
    console.log("Demonstrating the fast template engine with real-world templates\n");
    ...
    console.log(`Contains products: ${ecommerceResult.includes("Wireless Headphones")}`);
    console.log(`Contains user name: ${ecommerceResult.includes("John Smith")}`);
